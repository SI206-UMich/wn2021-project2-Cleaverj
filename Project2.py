...
def get_search_links():
    ...
    for item in anchor:
        anchor2 = item.find('a', class_ = 'bookTitle')
        partial_url = anchor2['href']
        full_url = 'https://www.goodreads.com' + partial_url
        empty_list.append(full_url)
...
class TestCases(unittest.TestCase):
    ...
    def test_get_titles_from_search_results(self):
        ...
        self.assertEqual(search_results[-1], ('Harry Potter: The Prequel (Harry Potter, #0.5)', 'J.K. Rowling'))
    ...
    def test_get_search_links(self):
        ...
        # check that each URL contains the correct url for Goodreads.com followed by /book/show/
            ...
            check = re.findall(reg, item)
            self.assertEqual(check[0], 'https://www.goodreads.com/book/show/')
    ...
    def test_get_book_summary(self):
        ...
        for url in TestCases.search_urls:
            book_sum = get_book_summary(url)
            summaries.append(book_sum)
